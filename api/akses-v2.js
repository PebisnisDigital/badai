...
<style id="badai-member-v4-style">
  ...
  .badai-affiliate-link-actions{display:grid;grid-template-columns:1fr auto;gap:7px;margin-top:8px}.badai-affiliate-copy,.badai-affiliate-open,.badai-affiliate-edit-code{min-height:38px;border-radius:10px;font:800 9px "Nunito",Arial,sans-serif;cursor:pointer}.badai-affiliate-copy{border:0;background:#ff4fa3;color:#090909;padding:0 12px}.badai-affiliate-copy.copied{background:#25D366;color:#07170d}.badai-affiliate-open{min-width:66px;padding:0 12px;display:flex;align-items:center;justify-content:center;border:1px solid #333;background:#151515;color:#fff;text-decoration:none}.badai-affiliate-code-slot{margin:6px 0 10px}.badai-affiliate-code-card{display:block!important;margin:0!important;padding:12px 13px!important;border-radius:12px!important;background:#0b0b0b!important;border:1px solid #2d2d2d!important;box-shadow:none!important}.badai-affiliate-code-line{display:flex!important;align-items:baseline!important;gap:7px!important;flex-wrap:wrap!important;color:#fff!important;font-family:"Raleway",Arial,sans-serif!important}.badai-affiliate-code-line b{margin:0!important;font-size:13px!important;font-weight:900!important;line-height:1.15!important;letter-spacing:-.01em!important}.badai-affiliate-code-line span{font-size:14px!important;font-weight:900!important;line-height:1.15!important;color:#ff8fc5!important;letter-spacing:.03em!important}.badai-affiliate-edit-code{display:inline-flex!important;align-items:center!important;justify-content:center!important;width:auto!important;min-height:34px!important;margin-top:9px!important;padding:0 13px!important;border:1px solid #3a3a3a;background:#151515;color:#fff;border-radius:9px;font:900 9px "Nunito",Arial,sans-serif;cursor:pointer}.badai-affiliate-loading,.badai-affiliate-empty{padding:13px;border:1px dashed #333;border-radius:13px;color:#888;text-align:center;font:600 9px "Nunito",Arial,sans-serif;line-height:1.5}

  @media(max-width:420px){.badai-member-header{padding:9px 10px;min-height:58px}.badai-member-header-logo img{height:30px;max-width:174px}.badai-member-help{min-height:37px;padding:0 11px;font-size:9px}.footer .label{font-size:9.7px!important}.community-hero{padding:17px}.community-hero h1{font-size:24px}.community-two{gap:7px}.community-card{padding:12px}.community-level{padding:8px;min-height:82px}}
</style>`;
...
document.addEventListener('DOMContentLoaded', function(){
  ...
  if(community){
    community.innerHTML='<div class="community-wrap">'+
      '<div class="community-hero"><div class="community-kicker">SELAMAT DATANG DI BADAI</div><h1>Belajar bareng, naik level bareng.</h1><p>Mulai dari komunitas, ikuti KulWA rutin, lalu buka lebih banyak akses saat kamu siap naik paket.</p><div class="community-plan-pill">⚡ STATUS: <strong id="communityPlanName">MEMBER PEMULA</strong></div></div>'+
      '<div class="community-wa"><div class="community-wa-icon">💬</div><div><h2>Grup WhatsApp BADAI</h2><p>Tempat KulWA, pengumuman, sharing, dan info terbaru dari BADAI.</p></div><a id="communityWhatsappLink" href="https://wa.me/6281237523626?text=Halo%20Admin%20BADAI%2C%20saya%20sudah%20jadi%20member%20dan%20ingin%20masuk%20Grup%20WhatsApp%20BADAI." target="_blank" rel="noopener noreferrer">MASUK GRUP WHATSAPP</a></div>'+
      '<div class="community-two"><div class="community-card"><div class="ico">📚</div><div class="eyebrow">KULWA RUTIN</div><h3>Belajar via WhatsApp</h3><p>Jadwal dan materi KulWA diumumkan langsung di grup BADAI.</p></div><div class="community-card"><div class="ico">📣</div><div class="eyebrow">INFO TERBARU</div><h3>Pantau Pengumuman</h3><p>Update kelas, agenda, dan kabar member dibagikan melalui komunitas.</p></div></div>'+
      '<div class="community-levels"><div class="community-levels-head"><h3>Level Member BADAI</h3><span>Naik paket = makin banyak akses</span></div><div class="community-level-grid"><div class="community-level" data-member-level="1"><div><small>LEVEL 1</small><b>GRATISAN</b></div><span>Komunitas + KulWA</span></div><div class="community-level" data-member-level="2"><div><small>LEVEL 2</small><b>PEMULA</b></div><span>Buka semua ILMU</span></div><div class="community-level" data-member-level="3"><div><small>LEVEL 3</small><b>UNTUNG</b></div><span>Ilmu + Bonus + Affiliasi</span></div></div></div></div>';
  }
  ...
  function bootAffiliate(attempt){prepareAffiliateBox();var code=affiliateCode();if(code){renderAffiliateChoices(code);return}if((attempt||0)<50)setTimeout(function(){bootAffiliate((attempt||0)+1)},250)}
