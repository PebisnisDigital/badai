...
document.addEventListener('DOMContentLoaded', function(){
  ...
  var pemulaMaterials=[
    ...
    {title:'BIKIN AFFILIATE AI',video:'',description:'Bikin konten affiliate dengan bantuan AI, mulai dari menentukan angle promosi, menyusun konsep konten, membuat visual atau video produk, sampai CTA yang menarik untuk membantu jualan tanpa harus mulai dari nol.',content:''},
