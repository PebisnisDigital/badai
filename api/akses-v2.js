...
<style id="badai-member-v4-style">
  ...
  .gratisan-about{padding:17px 18px;border-radius:18px;background:#101010;border:1px solid #252525}
  .gratisan-about-kicker{color:#ff77b7;font:700 8px "Nunito",Arial,sans-serif;letter-spacing:.08em;text-transform:uppercase}
  .gratisan-about h2{margin:4px 0 6px;color:#fff;font:700 18px "Nunito",Arial,sans-serif}
  .gratisan-about p{margin:0;color:#aaa;font:500 11px "Nunito",Arial,sans-serif;line-height:1.55}
  .gratisan-about strong{color:#fff;font-weight:700}
  .gratisan-benefits-head{margin:2px 2px 0}
  .gratisan-benefits-head h2{margin:0;color:#fff;font:700 18px "Nunito",Arial,sans-serif}
  .gratisan-benefits-head p{margin:4px 0 0;color:#8f8f8f;font:500 10px "Nunito",Arial,sans-serif}
  .gratisan-benefit-slider{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:8px}
  .gratisan-slide-card{min-width:0;overflow:hidden;border-radius:16px;background:#101010;border:1px solid #272727;display:flex;flex-direction:column}
  .gratisan-slide-image{aspect-ratio:4/3;display:grid;place-items:center;position:relative;overflow:hidden;background:linear-gradient(145deg,#24101a,#111)}
  .gratisan-slide-image::after{content:"";position:absolute;width:70px;height:70px;border-radius:50%;right:-25px;top:-25px;background:rgba(255,79,163,.18)}
  .gratisan-slide-image.green{background:linear-gradient(145deg,#0d2818,#111)}
  .gratisan-slide-image.green::after{background:rgba(37,211,102,.15)}
  .gratisan-slide-image span{position:relative;z-index:1;font-size:38px;filter:drop-shadow(0 8px 16px rgba(0,0,0,.25))}
  .gratisan-slide-body{padding:11px;display:flex;flex-direction:column;gap:7px;flex:1}
  .gratisan-slide-body h3{margin:0;color:#fff;font:600 12.5px "Nunito",Arial,sans-serif;line-height:1.2}
  .gratisan-slide-body p{margin:0;color:#8e8e8e;font:500 9px "Nunito",Arial,sans-serif;line-height:1.35}
  .gratisan-slide-body a{margin-top:auto;display:flex;align-items:center;justify-content:center;min-height:34px;padding:0 9px;border-radius:9px;background:#ff4fa3;color:#111;text-decoration:none;font:700 9px "Nunito",Arial,sans-serif;text-align:center}
  .gratisan-slide-card.whatsapp .gratisan-slide-body a{background:#25D366;color:#07170d}
  ...
  @media(max-width:420px){.badai-member-header{padding:9px 10px;min-height:58px}.badai-member-header-logo img{height:30px;max-width:174px}.badai-member-help{min-height:37px;padding:0 11px;font-size:9px}.footer .label{font-size:9.7px!important}.community-hero{padding:17px}.community-hero h1{font-size:24px}.community-access-grid{grid-template-columns:1fr;gap:7px}.community-access-card{padding:12px}.gratisan-benefit-slider{display:grid;grid-template-columns:none;grid-auto-flow:column;grid-auto-columns:82%;gap:8px;overflow-x:auto;scroll-snap-type:x mandatory;padding-bottom:4px;scrollbar-width:none}.gratisan-benefit-slider::-webkit-scrollbar{display:none}.gratisan-slide-card{scroll-snap-align:start}.gratisan-slide-image span{font-size:42px}.gratisan-slide-body h3{font-size:13px}.gratisan-slide-body a{min-height:38px;font-size:9.5px}.community-two{gap:7px}.community-card{padding:12px}.community-level{padding:8px;min-height:82px}}
</style>`;
...
document.addEventListener('DOMContentLoaded', function(){
  ...
  if(community){
    community.innerHTML='<div class="community-wrap">'+
      '<div class="community-hero"><div class="community-kicker">MEMBER BADAI</div><h1>Gratisan</h1><p>Pintu masuk untuk mulai belajar, kenalan dengan ekosistem BADAI, dan menikmati benefit gratis yang sudah kami siapkan.</p><div class="community-plan-pill">⚡ STATUS: <strong id="communityPlanName">MEMBER GRATISAN</strong></div></div>'+
      '<div class="gratisan-about"><div class="gratisan-about-kicker">TENTANG BADAI</div><h2>Belajar Apa Aja Dengan AI</h2><p><strong>BADAI</strong> adalah komunitas belajar AI yang dibuat supaya siapa pun bisa mulai dari level paling dasar, belajar lewat materi yang praktis, mengikuti update terbaru, dan terhubung dengan sesama anggota. Di <strong>Paket Gratisan</strong>, kamu sudah mendapatkan beberapa akses berikut.</p></div>'+
      '<div class="gratisan-benefits-head"><h2>Yang Kamu Dapatkan</h2><p>Geser kartunya dan masuk ke semua akses yang tersedia.</p></div>'+
      '<div class="gratisan-benefit-slider">'+
        '<div class="gratisan-slide-card whatsapp"><div class="gratisan-slide-image green"><span>🎓</span></div><div class="gratisan-slide-body"><h3>Kuliah WhatsApp Gratis</h3><p>Ikuti sesi KulWA gratis dan belajar bareng member BADAI.</p><a href="https://chat.whatsapp.com/LCGm5LowkYG3NiHKItShC6" target="_blank" rel="noopener noreferrer">IKUT KULWA</a></div></div>'+
        '<div class="gratisan-slide-card"><div class="gratisan-slide-image"><span>📘</span></div><div class="gratisan-slide-body"><h3>Ebook Gratis</h3><p>Dapatkan ebook dan materi gratis melalui Channel BADAI.</p><a href="https://whatsapp.com/channel/0029VbAtteJ3rZZbGr9Dt21s" target="_blank" rel="noopener noreferrer">AMBIL EBOOK</a></div></div>'+
        '<div class="gratisan-slide-card"><div class="gratisan-slide-image"><span>🤖</span></div><div class="gratisan-slide-body"><h3>Belajar AI Gratis</h3><p>Ikuti tips, update, dan pembelajaran AI gratis dari BADAI.</p><a href="https://whatsapp.com/channel/0029VbAtteJ3rZZbGr9Dt21s" target="_blank" rel="noopener noreferrer">BELAJAR AI</a></div></div>'+
        '<div class="gratisan-slide-card whatsapp"><div class="gratisan-slide-image green"><span>💬</span></div><div class="gratisan-slide-body"><h3>Grup Anggota BADAI</h3><p>Masuk komunitas dan terhubung dengan sesama anggota BADAI.</p><a href="https://chat.whatsapp.com/IyZyfDpJKPAExjdIplD5o5" target="_blank" rel="noopener noreferrer">MASUK GRUP</a></div></div>'+
      '</div></div>';
  }
