...
<style id="badai-member-v4-style">
  ...
  .gratisan-rules{padding:15px 16px;border-radius:18px;background:#101010;border:1px solid #252525}
  .gratisan-rules-head{display:flex;align-items:center;gap:8px;margin-bottom:8px}
  .gratisan-rules-head span{font-size:19px}
  .gratisan-rules h2{margin:0;color:#fff;font:700 16px "Nunito",Arial,sans-serif}
  .gratisan-rules p{margin:0;color:#a8a8a8;font:500 10.5px "Nunito",Arial,sans-serif;line-height:1.55}
  .gratisan-rules-list{display:grid;gap:5px;margin-top:10px}
  .gratisan-rule{display:flex;gap:7px;align-items:flex-start;color:#d8d8d8;font:500 10px "Nunito",Arial,sans-serif;line-height:1.45}
  .gratisan-rule b{color:#ff77b7;font-weight:700}
  ...
  .gratisan-benefits-head p{margin:3px 0 0;color:#8f8f8f;font:500 10px "Nunito",Arial,sans-serif}
  .gratisan-benefit-list{display:grid;gap:7px}
  .gratisan-benefit{display:grid;grid-template-columns:38px minmax(0,1fr) auto;align-items:center;gap:10px;padding:10px 11px;border-radius:14px;background:#101010;border:1px solid #272727}
  .gratisan-benefit-icon{width:38px;height:38px;border-radius:12px;display:grid;place-items:center;background:#171717;font-size:19px}
  .gratisan-benefit-info h3{margin:0;color:#fff;font:600 13px "Nunito",Arial,sans-serif;line-height:1.15}
  .gratisan-benefit-info p{margin:2px 0 0;color:#888;font:500 9px "Nunito",Arial,sans-serif;line-height:1.3}
  .gratisan-benefit a{display:inline-flex;align-items:center;justify-content:center;min-height:34px;padding:0 11px;border-radius:9px;background:#ff4fa3;color:#111;text-decoration:none;font:700 9px "Nunito",Arial,sans-serif;white-space:nowrap}
  .gratisan-benefit.whatsapp a{background:#25D366;color:#07170d}
  ...
  @media(max-width:420px){.badai-member-header{padding:9px 10px;min-height:58px}.badai-member-header-logo img{height:30px;max-width:174px}.badai-member-help{min-height:37px;padding:0 11px;font-size:9px}.footer .label{font-size:9.7px!important}.community-hero{padding:17px}.community-hero h1{font-size:24px}.community-access-grid{grid-template-columns:1fr;gap:7px}.community-access-card{padding:12px}.gratisan-benefit{grid-template-columns:34px minmax(0,1fr);gap:8px;padding:9px}.gratisan-benefit-icon{width:34px;height:34px;font-size:17px}.gratisan-benefit a{grid-column:1/-1;min-height:36px;width:100%;font-size:9.5px}.community-two{gap:7px}.community-card{padding:12px}.community-level{padding:8px;min-height:82px}}
</style>`;
...
document.addEventListener('DOMContentLoaded', function(){
  ...
  if(community){
    community.innerHTML='<div class="community-wrap">'+
      '<div class="community-hero"><div class="community-kicker">MEMBER BADAI</div><h1>Gratisan</h1><p>Kamu tetap dapat akses belajar dan komunitas BADAI secara gratis. Baca aturan singkatnya, lalu masuk ke semua akses di bawah.</p><div class="community-plan-pill">⚡ STATUS: <strong id="communityPlanName">MEMBER GRATISAN</strong></div></div>'+
      '<div class="gratisan-rules"><div class="gratisan-rules-head"><span>📌</span><h2>Aturan & Tata Tertib</h2></div><p>Biar komunitas tetap nyaman dan bermanfaat untuk semua member:</p><div class="gratisan-rules-list"><div class="gratisan-rule"><b>•</b><span>Gunakan grup untuk belajar, bertanya, dan diskusi seputar BADAI & AI.</span></div><div class="gratisan-rule"><b>•</b><span>Jaga sopan santun. Hindari spam, promosi, atau kirim link tanpa izin admin.</span></div><div class="gratisan-rule"><b>•</b><span>Materi dan akses khusus member tidak dibagikan sembarangan ke luar komunitas.</span></div><div class="gratisan-rule"><b>•</b><span>Ikuti arahan admin dan gunakan semua akses resmi BADAI di bawah ini.</span></div></div></div>'+
      '<div class="gratisan-benefits-head"><h2>Benefit Member Gratisan</h2><p>Klik satu per satu supaya semua benefit kamu aktif.</p></div>'+
      '<div class="gratisan-benefit-list">'+
        '<div class="gratisan-benefit whatsapp"><div class="gratisan-benefit-icon">🎓</div><div class="gratisan-benefit-info"><h3>Ikutan Kuliah WhatsApp Gratis</h3><p>Masuk grup KulWA dan ikuti sesi belajar gratis BADAI.</p></div><a href="https://chat.whatsapp.com/LCGm5LowkYG3NiHKItShC6" target="_blank" rel="noopener noreferrer">IKUT KULWA</a></div>'+
        '<div class="gratisan-benefit"><div class="gratisan-benefit-icon">📘</div><div class="gratisan-benefit-info"><h3>Mendapatkan Ebook Gratis</h3><p>Akses ebook dan materi gratis yang dibagikan lewat Channel BADAI.</p></div><a href="https://whatsapp.com/channel/0029VbAtteJ3rZZbGr9Dt21s" target="_blank" rel="noopener noreferrer">AMBIL EBOOK</a></div>'+
        '<div class="gratisan-benefit"><div class="gratisan-benefit-icon">🤖</div><div class="gratisan-benefit-info"><h3>Belajar AI Gratis</h3><p>Dapatkan tips, update, dan materi belajar AI gratis.</p></div><a href="https://whatsapp.com/channel/0029VbAtteJ3rZZbGr9Dt21s" target="_blank" rel="noopener noreferrer">BELAJAR AI</a></div>'+
        '<div class="gratisan-benefit whatsapp"><div class="gratisan-benefit-icon">💬</div><div class="gratisan-benefit-info"><h3>Grup Anggota BADAI</h3><p>Gabung dan terhubung dengan sesama anggota BADAI.</p></div><a href="https://chat.whatsapp.com/IyZyfDpJKPAExjdIplD5o5" target="_blank" rel="noopener noreferrer">MASUK GRUP</a></div>'+
      '</div></div>';
  }
