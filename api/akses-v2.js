...
<style id="badai-member-v4-style">
  ...
  .badai-affiliate-link-actions{display:grid;grid-template-columns:1fr auto;gap:7px;margin-top:8px}.badai-affiliate-copy,.badai-affiliate-open,.badai-affiliate-edit-code{min-height:38px;border-radius:10px;font:800 9px "Nunito",Arial,sans-serif;cursor:pointer}.badai-affiliate-copy{border:0;background:#ff4fa3;color:#090909;padding:0 12px}.badai-affiliate-copy.copied{background:#25D366;color:#07170d}.badai-affiliate-open{min-width:66px;padding:0 12px;display:flex;align-items:center;justify-content:center;border:1px solid #333;background:#151515;color:#fff;text-decoration:none}.badai-affiliate-code-slot{margin:6px 0 10px}.badai-affiliate-code-card{display:grid!important;grid-template-columns:auto 1fr auto!important;align-items:center!important;gap:8px!important;margin:0!important;padding:10px 11px!important;border-radius:12px!important;background:#0b0b0b!important;border:1px solid #2d2d2d!important;box-shadow:none!important}.badai-affiliate-code-card>b{margin:0!important}.badai-affiliate-code-card>span{justify-self:start!important}.badai-affiliate-edit-code{width:auto!important;min-height:32px;padding:0 11px;border:1px solid #3a3a3a;background:#151515;color:#fff;border-radius:9px;font:800 8px "Nunito",Arial,sans-serif;cursor:pointer}.badai-affiliate-loading,.badai-affiliate-empty{padding:13px;border:1px dashed #333;border-radius:13px;color:#888;text-align:center;font:600 9px "Nunito",Arial,sans-serif;line-height:1.5}
