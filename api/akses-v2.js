...
<style id="badai-member-v4-style">
  ...
  @media(max-width:420px){.badai-member-header{padding:9px 10px;min-height:58px}.badai-member-header-logo img{height:30px;max-width:174px}.badai-member-help{min-height:37px;padding:0 11px;font-size:9px}.footer .label{font-size:9.7px!important}.community-hero{padding:17px}.community-hero h1{font-size:24px}.community-access-grid{grid-template-columns:1fr;gap:7px}.community-access-card{padding:12px}.community-two{gap:7px}.community-card{padding:12px}.community-level{padding:8px;min-height:82px}}
</style>`;
...
document.addEventListener('DOMContentLoaded', function(){
  ...
  if(community){
    community.innerHTML='<div class="community-wrap">'+
      ...
      '<div class="community-access-grid"><div class="community-access-card channel"><div class="community-access-icon">📢</div><div><h2>Channel BADAI</h2><p>Update singkat, info kelas, dan pengumuman terbaru dari BADAI.</p></div><a href="https://whatsapp.com/channel/0029VbAtteJ3rZZbGr9Dt21s" target="_blank" rel="noopener noreferrer">BUKA CHANNEL BADAI</a></div><div class="community-access-card"><div class="community-access-icon">💬</div><div><h2>Komunitas BADAI</h2><p>Tempat ngobrol, KulWA, sharing, dan belajar bareng member BADAI.</p></div><a href="https://chat.whatsapp.com/IyZyfDpJKPAExjdIplD5o5" target="_blank" rel="noopener noreferrer">GABUNG KOMUNITAS BADAI</a></div></div>'+
