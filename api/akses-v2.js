...
document.addEventListener('DOMContentLoaded', function(){
  ...
  var pemulaMaterials=[
    ...
    {title:'BIKIN ANIMASI MANUSIA GUA',video:'',description:'Bikin animasi manusia gua dengan bantuan AI, mulai dari konsep karakter, suasana zaman purba, ekspresi, gerakan, sampai adegan yang menarik untuk konten.',content:'Klik tombol TOOLS untuk mulai membuat Animasi Manusia Gua.',ready:true,toolLabel:'TOOLS ANIMASI MANUSIA GUA',toolUrl:'https://share.gemini.google/nklblYrmb5gn'},
