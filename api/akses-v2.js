...
<style id="badai-member-v4-style">
  ...
  .gratisan-offer-label{margin:2px 0 12px;color:#fff;font-size:19px;font-weight:700;text-align:center;line-height:1.15}
  ...
  .gratisan-price-box{margin-top:14px;padding:16px 14px 15px;border-radius:14px;background:#161016;border:1px solid #4d263a;text-align:center}
  .gratisan-price-box small{display:block;color:#a98a99;font-size:10px;font-weight:700;letter-spacing:.06em}
  .gratisan-price-total{display:block;margin-top:5px;color:#b7b7b7;font-size:27px;font-weight:800;line-height:1.05;text-decoration:line-through;text-decoration-thickness:2px;text-decoration-color:#ff4fa3}
  .gratisan-price{display:block;margin-top:7px;color:#25D366;font-size:34px;font-weight:900;line-height:1}
  ...
  @media(max-width:420px){.badai-member-header{padding:9px 10px;min-height:58px}.badai-member-header-logo img{height:30px;max-width:174px}.badai-member-help{min-height:37px;padding:0 11px;font-size:9px}.footer .label{font-size:9.7px!important}.community-hero{padding:17px}.community-hero h1{font-size:24px}.community-access-grid{grid-template-columns:1fr;gap:7px}.community-access-card{padding:12px}.gratisan-offer-card{padding:14px;border-radius:18px}.gratisan-offer-label{font-size:18px}.gratisan-value-row{padding:9px}.gratisan-value-row b{font-size:11px}.gratisan-value-row span:last-child{font-size:9.5px}.gratisan-price-total{font-size:24px}.gratisan-price{font-size:31px}.gratisan-offer-cta{min-height:46px}.community-two{gap:7px}.community-card{padding:12px}.community-level{padding:8px;min-height:82px}}
</style>`;
...
document.addEventListener('DOMContentLoaded', function(){
  ...
  if(community){
    community.innerHTML='<div class="gratisan-offer-card">'+
      ...
      '</div>'+
      '<div class="gratisan-price-box"><small>TOTAL NILAI</small><span class="gratisan-price-total">Rp117.000</span><span class="gratisan-price">GRATIS</span></div>'+
