...
document.addEventListener('DOMContentLoaded', function(){
  ...
  var pemulaMaterials=[
    ...
    {title:'BIKIN DIY CRAFT',video:'',description:'Bikin proyek DIY Craft kreatif dengan bantuan AI, mulai dari mencari ide, menyusun konsep dan desain, sampai mengembangkan hasil kerajinan menjadi konten yang menarik.',content:''},
